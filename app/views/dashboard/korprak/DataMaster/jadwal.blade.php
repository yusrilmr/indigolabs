@include('header')
@include('dashboard/korprak/menu_korprak')
    <!--main content start-->
                    ...
                    <div class="tab-content">
                        <div id="input" class="tab-pane active">
                            ...
                            <div class="position-center">
                                {{Form::open(array('action' => 'KorprakController@storeJadwal'))}}
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td style="min-width:140px;max-width:140px;">
                                        ...
                                        {{ link_to_action('KorprakController@deleteJadwal', 'Delete', array($jadwal_data->jadwal_id), ['class' => 'btn btn-danger center-block', 'onclick' => 'return confirm(\'Are you sure you want to delete this item?\');' ])}}
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                {{Form::open(array('action' => 'KorprakController@updateJadwal'))}}
