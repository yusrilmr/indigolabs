					...
					<div class="panel-body profile-information">
						<div class="col-md-3">
							<div class="profile-pic text-center">
                               <img src='uploads/user_profpic/{{ $data->asisten_foto }}.jpeg' alt=""/>
                           </div>
						</div>
						
						<div class="col-md-9">
                           	<div class="profile-desk">
                               	<h1>{{ $data->asisten_nama }}</h1>
                               	<h5>{{ $data->asisten_kode }}</h5>
                           	</div>
                           	<div class="edtpass">
	                        	...
	                        	<div class="row">
	                        		...
	                        		<div class="col-md-6">
		                                <div class="form-horizontal">
		                                	<div class="form-group">
		                                        ...
		                                        <label class="col-md-6 control-label">{{ $data->asisten_nim }}</label>
			                                </div>    
		                             		<div class="form-group">
			                                	<label class="col-lg-3 control-label">Nama </label>
			                                	<label class="col-lg-1 control-label">:</label>
			                                	<label class="col-md-6 control-label">{{ $data->asisten_nama }}</label>
			                  				</div>    
		                            ...
		                            <div class="col-md-6">
		                            	<div class="form-horizontal">
		                            		<div class="form-group">	
			                                	...
			                                	<label class="col-lg-1 control-label">:</label>
			                                	<label class="col-md-6 control-label" >{{ $data->asisten_email }}</label>
											</div>    
		                             		<div class="form-group">
			                                	<label class="col-lg-3 control-label">Telp </label>
			                                	<label class="col-lg-1 control-label">:</label>
			                                	<label class="col-md-6 control-label">{{ $data->asisten_telp }}</label>
		                                    </div>
		                                </div>
		                            </div>
		                            </div>
		                            ...
		                            <div class="position-center" style="width:40%">
		                            	...
		                            	<div class="form-group">
			                                	...
			                                	<label class="col-lg-1 control-label">:</label>
			                                	<label class="col-md-6 control-label">Asisten</label>
			                  				</div>
		                            		<div class="form-group">
	                       	...
	                       	<div id="edit" class="tab-pane ">
	                        	<div class="position-center">
		                            ...
		                            <div class="form-group">
			                            ...
			                            <div class="col-lg-6">
			                            	{{Form::text('nimVal', $data->asisten_nim, array('class' => 'form-control', 'disabled')) }}
			                        	</div>
			                        </div>
			                        <div class="form-group">
			                            {{Form::label('nama', 'Nama', array('class' => 'col-lg-2 control-label'))}}
			                            <div class="col-lg-6">
			                            	{{Form::text('namaVal', $data->asisten_nama, array('class' => 'form-control', 'disabled')) }}
			                        	</div>
			                        </div>
			                        <div class="prf-contacts sttng">
										<h2>Avatar</h2>
		                            ...
		                            <div class="form-group">
			                            ...
			                            <div class="col-lg-6">
			                            	{{Form::text('email', $data->asisten_email, array('class' => 'form-control')) }}
			                        	</div>
			                        </div>
			                        <div class="form-group">
			                            {{Form::label('telp', 'Telp', array('class' => 'col-lg-2 control-label'))}}
			                            <div class="col-lg-6">
			                            	{{Form::text('phoneNumber', $data->asisten_telp, array('class' => 'form-control')) }}
			                        	</div>
			                        </div>
			                        <div class="form-group">
