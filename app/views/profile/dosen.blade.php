					...
					<div class="panel-body profile-information">
						<div class="col-md-3">
							<div class="profile-pic text-center">
                               <img src='uploads/user_profpic/{{ $data->dosen_foto }}.jpeg' alt=""/>
                           </div>
						</div>
						
						<div class="col-md-9">
                           	<div class="profile-desk">
                               	<h1>{{ $data->dosen_nama }}</h1>
                               	<h5>{{ $data->dosen_nip }}</h5>
                           	</div>
                           	<div class="edtpass">
	                        		...
	                        		<div class="col-md-6">
		                                <div class="form-horizontal">
		                                	<div class="form-group">
		                                        ...
		                                        <label class="col-md-6 control-label">{{ $data->dosen_nip }}</label>
			                                </div>    
		                             		<div class="form-group">
			                                	<label class="col-lg-3 control-label">Nama </label>
			                                	<label class="col-lg-1 control-label">:</label>
			                                	<label class="col-md-6 control-label">{{ $data->dosen_nama }}</label>
			                  				</div>    
		                            ...
		                            <div class="col-md-6">
		                            	<div class="form-horizontal">
		                            		<div class="form-group">	
			                                	...
			                                	<label class="col-lg-1 control-label">:</label>
			                                	<label class="col-md-6 control-label" >{{ $data->dosen_email }}</label>
											</div>    
		                             		<div class="form-group">
			                                	<label class="col-lg-3 control-label">Telp </label>
			                                	<label class="col-lg-1 control-label">:</label>
			                                	<label class="col-md-6 control-label">{{ $data->dosen_telp }}</label>
		                                    </div>
		                                </div>
		                            </div>
		                            </div>
	                       	...
	                       	<div id="edit" class="tab-pane ">
	                        	<div class="position-center">
		                            ...
		                            <div class="form-group">
			                            ...
			                            <div class="col-lg-6">
			                            	{{Form::text('nimVal', $data->dosen_nip, array('class' => 'form-control', 'disabled')) }}
			                        	</div>
			                        </div>
			                        <div class="form-group">
			                            {{Form::label('nama', 'Nama', array('class' => 'col-lg-2 control-label'))}}
			                            <div class="col-lg-6">
			                            	{{Form::text('namaVal', $data->dosen_nama, array('class' => 'form-control', 'disabled')) }}
			                        	</div>
			                        </div>
			                        <div class="prf-contacts sttng">
										<h2>Avatar</h2>
		                            ...
		                            <div class="form-group">
			                            ...
			                            <div class="col-lg-6">
			                            	{{Form::text('email', $data->dosen_email, array('class' => 'form-control')) }}
			                        	</div>
			                        </div>
			                        <div class="form-group">
			                            {{Form::label('telp', 'Telp', array('class' => 'col-lg-2 control-label'))}}
			                            <div class="col-lg-6">
			                            	{{Form::text('phoneNumber', $data->dosen_telp, array('class' => 'form-control')) }}
			                        	</div>
			                        </div>
			                        <div class="form-group">
